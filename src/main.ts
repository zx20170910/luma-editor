...
$('app').innerHTML = `
  <header class="titlebar">
    <div class="window-space"></div><div class="brand"><span class="brand-mark">L</span><span>Luma <b>Editor</b></span><span class="version">1.2</span></div>
