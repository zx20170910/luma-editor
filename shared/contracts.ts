...
export interface Preferences { fontSize: number; tabSize: number; wordWrap: boolean; minimap: boolean; formatOnSave: boolean; theme: 'dark' | 'light'; preview: boolean; sidebar: boolean }
